...
namespace IeidjtuKCB.Model
{
	...
	/// <summary>
	/// 实体类vw_Curricula 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Table("vw_Curricula")]
	[Serializable]
	public partial class vw_Curricula : Entity 
	{
		#region Model
		private int _CCID;
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","vw_Curricula");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field CCID = new Field("CCID","vw_Curricula","CCID");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field CCode = new Field("CCode","vw_Curricula","CCode");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field CPyCode = new Field("CPyCode","vw_Curricula","CPyCode");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field CCname = new Field("CCname","vw_Curricula","CCname");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field DeptName = new Field("DeptName","vw_Curricula","DeptName");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Deptcode = new Field("Deptcode","vw_Curricula","Deptcode");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field MaxNum = new Field("MaxNum","vw_Curricula","MaxNum");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Source = new Field("Source","vw_Curricula","Source");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Period = new Field("Period","vw_Curricula","Period");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Prelect = new Field("Prelect","vw_Curricula","Prelect");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Experiment = new Field("Experiment","vw_Curricula","Experiment");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field OnComputer = new Field("OnComputer","vw_Curricula","OnComputer");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Examsort = new Field("Examsort","vw_Curricula","Examsort");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Memo = new Field("Memo","vw_Curricula","Memo");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field CCnameEng = new Field("CCnameEng","vw_Curricula","CCnameEng");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Csort = new Field("Csort","vw_Curricula","Csort");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Cunit = new Field("Cunit","vw_Curricula","Cunit");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Sort = new Field("Sort","vw_Curricula","Sort");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field ClassNum = new Field("ClassNum","vw_Curricula","ClassNum");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field MMedia = new Field("MMedia","vw_Curricula","MMedia");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field RoomSort = new Field("RoomSort","vw_Curricula","RoomSort");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Other = new Field("Other","vw_Curricula","Other");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field NormalScale = new Field("NormalScale","vw_Curricula","NormalScale");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field ExpScale = new Field("ExpScale","vw_Curricula","ExpScale");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field ExamineScale = new Field("ExamineScale","vw_Curricula","ExamineScale");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Resume = new Field("Resume","vw_Curricula","Resume");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field ModifyOper = new Field("ModifyOper","vw_Curricula","ModifyOper");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field NewOper = new Field("NewOper","vw_Curricula","NewOper");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field NewDate = new Field("NewDate","vw_Curricula","NewDate");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field StuNum = new Field("StuNum","vw_Curricula","StuNum");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field UseDControl = new Field("UseDControl","vw_Curricula","UseDControl");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field RsGroup = new Field("RsGroup","vw_Curricula","RsGroup");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field IFPK = new Field("IFPK","vw_Curricula","IFPK");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field IFCheck = new Field("IFCheck","vw_Curricula","IFCheck");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field IFCheckBY = new Field("IFCheckBY","vw_Curricula","IFCheckBY");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Mark = new Field("Mark","vw_Curricula","Mark");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field ModifyDate = new Field("ModifyDate","vw_Curricula","ModifyDate");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field DeptID = new Field("DeptID","vw_Curricula","DeptID");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field EachSection = new Field("EachSection","vw_Curricula","EachSection");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field OutLinenum = new Field("OutLinenum","vw_Curricula","OutLinenum");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field CLevel = new Field("CLevel","vw_Curricula","CLevel");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field SelectMode = new Field("SelectMode","vw_Curricula","SelectMode");
		}
		#endregion
