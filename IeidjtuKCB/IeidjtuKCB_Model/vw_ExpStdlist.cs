...
namespace IeidjtuKCB.Model
{
	...
	/// <summary>
	/// 实体类vw_ExpStdlist 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Table("vw_ExpStdlist")]
	[Serializable]
	public partial class vw_ExpStdlist : Entity 
	{
		#region Model
		private int? _SSID;
		private int? _stdid;
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","vw_ExpStdlist");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field SSID = new Field("SSID","vw_ExpStdlist","SSID");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field stdid = new Field("stdid","vw_ExpStdlist","stdid");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field SPID = new Field("SPID","vw_ExpStdlist","SPID");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field GRID = new Field("GRID","vw_ExpStdlist","GRID");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field CSortCode = new Field("CSortCode","vw_ExpStdlist","CSortCode");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Csort = new Field("Csort","vw_ExpStdlist","Csort");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field GetSource = new Field("GetSource","vw_ExpStdlist","GetSource");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field NeedSource = new Field("NeedSource","vw_ExpStdlist","NeedSource");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field LastCalDate = new Field("LastCalDate","vw_ExpStdlist","LastCalDate");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field StdCode = new Field("StdCode","vw_ExpStdlist","StdCode");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field StdName = new Field("StdName","vw_ExpStdlist","StdName");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field SPName = new Field("SPName","vw_ExpStdlist","SPName");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field GRName = new Field("GRName","vw_ExpStdlist","GRName");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field DeptID = new Field("DeptID","vw_ExpStdlist","DeptID");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field ClassName = new Field("ClassName","vw_ExpStdlist","ClassName");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field AllNeed = new Field("AllNeed","vw_ExpStdlist","AllNeed");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field AllGet = new Field("AllGet","vw_ExpStdlist","AllGet");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field CXSource = new Field("CXSource","vw_ExpStdlist","CXSource");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field BadSource = new Field("BadSource","vw_ExpStdlist","BadSource");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field LostNum = new Field("LostNum","vw_ExpStdlist","LostNum");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field MainAvg = new Field("MainAvg","vw_ExpStdlist","MainAvg");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field byState = new Field("byState","vw_ExpStdlist","byState");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field state = new Field("state","vw_ExpStdlist","state");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field MainAvg2 = new Field("MainAvg2","vw_ExpStdlist","MainAvg2");
		}
		#endregion
